...
import (
	...
	// Ensure "go mod tidy" doesn't remove the gitlab.titandc.io/go-api/crypto module
	// dependency, which is necessary to access the field.Element type.
	_ "gitlab.titandc.io/go-api/crypto/curve25519"
)

//go:generate go run . -out ../fe_amd64.s -stubs ../fe_amd64.go -pkg field

func main() {
	Package("gitlab.titandc.io/go-api/crypto/curve25519/internal/field")
